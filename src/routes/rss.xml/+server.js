...
const website = 'https://www.w3ieg.com';
    ...
    <rss xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:content="http://purl.org/rss/1.0/modules/content/" xmlns:atom="http://www.w3.org/2005/Atom" version="2.0">
      <channel>
        ...
        ${article
              ...
              <category domain="${website}/articles/${categories.filter((val) => {
                if (val.title.includes(post.fields.category)) {
                  return val;
                }
              }).map((link) => link.link)}">${post.fields.category}</category>
              <enclosure url="https:${
